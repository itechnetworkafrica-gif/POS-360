      ...
      <div className="hidden lg:flex lg:w-[52%] flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-10 max-w-[380px]">
          ...
          <div className="flex items-center gap-3">
            <div className="h-12 w-12 rounded-xl flex items-center justify-center" style={{ background: "rgba(90,200,90,0.12)", border: "1px solid rgba(90,200,90,0.3)" }}>
              <img src="/logo.png" alt="POS360" className="h-8 w-8 object-contain" />
            </div>
            <div>
              <h1 className="text-2xl font-black text-white">POS<span style={{ color: "#5AC85A" }}>360</span></h1>
              <p className="text-[11px] text-white/30 tracking-widest uppercase">iTech Network Africa</p>
            </div>
          </div>
          ...
          {tab === "login" && (
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <p className="text-sm text-muted-foreground">Sign in to your POS360 account</p>
              </div>
