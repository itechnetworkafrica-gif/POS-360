...
const mockNotifications = [
  { id: 1, type: "info",     icon: Bell,           message: "Welcome to Gotecx POS! Start by adding your first product.",  time: "just now", read: false },
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className={`h-14 flex items-center border-b border-border px-3 ${collapsed ? "justify-center" : "justify-between"} shrink-0`}>
        {!collapsed
          ? <span className="font-black text-lg tracking-tight select-none">Gotecx <span className="text-primary">POS</span></span>
          : <div className="h-7 w-7 rounded-lg bg-primary/10 border border-primary/30 flex items-center justify-center font-black text-sm text-primary select-none">G</div>}
      </div>
        ...
        <header className="h-14 flex items-center justify-between border-b border-border px-4 bg-card shrink-0">
          <div className="flex items-center gap-2">
            ...
            <div className="md:hidden">
              <span className="font-black text-base tracking-tight select-none">Gotecx <span className="text-primary">POS</span></span>
            </div>
          </div>
