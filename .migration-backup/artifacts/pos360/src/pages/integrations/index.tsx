...
const integrations = [
  ...
  { id: 9, name: "Shopify", description: "Sync products and orders between POS360 and Shopify", category: "E-Commerce", connected: false, logo: "🏪" },
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">Connect POS360 with your favorite tools and platforms</p>
      </div>
